...
I do remember. Before I met you, I felt incomplete, partial. And it is not about my feelings towards you. It is about my ambitions, the very definition of what I am as a person in this world, what I am able to prove myself capable of doing, my ultimate reponsibility for making at least some part of this world a bit better than it was. You know what I mean. Patriotic feelings aside, Land of Ezeek is a god forsaken shithole and a pain in the ass for all its neighbours, as your father had delicatedly put it; and I believed that I can make it better. Nor the Dark Domain is a merry paradise where everyone lives happily ever after, you know that too. Corruption and social prejudices are everywhere, on both sides of the border.
...
In these moments I felt like by sharing our mutual goals we complete each other, we are two missing pieces of the puzzle of this world, who together make up more than one obscure corner but rather complete the entire picture infusing it with some important new quality.
...
\say{Alice,} said Ferin tiredly, {are you seriously not seeing this? Do you really feel like this is some sort of coincidence or providence or, rather, \textit{deserved} outcome?}

\say{What do you mean?}

\say{I mean that just twelve hours ago we were essentially the warband of vagabonds committing grave crimes of rebellion, assault on the government institution and  attempted murder on a rightful ruler. Now, you are the Queen and I am still alive. Between these two points lies endless universe of possibilities all of which had suddenly turned in our favor for no obvious reason. Just look and think! City watch could have easily banned us from entering the city. The Citadel guards could have easily killed us before we even touched the gates to the Outer Court if only there were two good archers on the wall. Did you notice the sanctum was not guarded at all? And then Lord Lugen did not kill me right on the spot, which would have been justified by any moral standard as a self-defense. And then he agreed on that ridiculous trial. No, not agreed, insisted! It was his idea all along. And then he lost and \dots}

\say{Did as he promised instead of vaporizing us all and forgetting this minor nuisance?}, continued Alice, smiling sarcastically, \say{Are you seriously blaming him for being honest to his word?}

\say{Dark Overlords are not\dots} started Ferin but stopped abruptly.

\say{Not honest? They are tyrannical, sadistical, ruthless, maniacal, crazy, power-hungry liars and generally shit of this world. Sounds familiar?} Smile vanished from Alice's face and her voice began to sound threateningly.

\say{All right, all right! I see where this is going -- it is all propaganda, part of the traditional public image, right?! And he really is wise, just, loving and caring fatherly figure ruler for all his eternally thankful subjects, am I right?}

\say{You do not seem to have any evidence to argue otherwise}, replied Alice quietly.

Ferin choked for a moment, looking at Alice with surprise, and then said \say{Whatever. But I digress. My point was that beween yesterday and now there were certain key events that had each been turned and tuned so that we may proceed to the next one almost unopposed. In other words, it was \textit{planned}.}

% Smooth mood transition needed here
...
So what changed since then? Oh, he handed you his power on a plate and all of a sudden he is loveable daddy once again? Decided that you are finally ready after all these years he spent schooling you to be his successor ruler. Made sure the complex clockwork of Dark Domain is greased to the specs and is in a competent hands.}

Alice very gently touched his lips with her fingers and said in a soft quiet voice \say{Ferin, please don't say that. It is not true, and it is more complex than you think. I had some conversation with father yesterday before you had the Judgement of All Gods commenced. He is much more human than I previously thought. And a very tired one. My running away actually hurt him deeply and I am feeling guilty over it.}

\say{This is called a manipulation, my dear Alice -- imposition of guilt on someone to make them help achieve one's own ulterior goals. Parents are prone to it just as well as the others. And I already see, from the way you look and talk, that you took this bait seriously, that you plan on ruling the Dark Domain thoroughly and already mentally sorting the order of envoys and ambassadors you shall meet today in the most politically effective order.}
...
\say{You have got at least one thing wrong, my dear}, murmured Alice, \say{no matter how good the clockwork of the Domain is greased, I can not be absolutely sure where its loyalty truly lies -- in the Domain, in the throne or in my father. That still remains to be seen. Meanwhile, I will need someone whom I can trust and confide.}
...
\say{Yes, my Lady. They were given some amount of money, strong suggestion to keep their mouth shut about everthing that happened yesterday and avoid any further association of this kind lest they are tired of their own heads upon their shoulders, and set free, per Lord Lugen's order.}
...
General Nhusen in a black uniform with just a few shiny metal trinkets appeared in the doorway carrying a briefcase, saluted and followed Alice's gesture, sat on the chair at a table. Next came Ferin and sat on the opposite side.
...
According to the general plan, both army groups would seem to "cut" about one sixth of the Inilpan territory, least populated and scarce with anything valuable. Group B were to present credible threat to the Roraz capital city by advancing upstream Inilpan river but then "unexpectedly" turn westward to help main invasion forces of Group A. Had everything gone according to a plan, both army groups would join at the general vicinity of the Kalpan rivers junction, besieging the strategically important city of the same name.}
...
\say{But \textit{I am} acting in the best interest of the Nation of Ezeek, Your Majesty. That it may have somehow coincided with your best interest too is rather lucky opportunity which would be very sad to miss. The legality is always relative, especially when it comes to ancient traditions, and you will be surprised just how many of my compatriots tend to agree with that nowadays.}

\say{Thank you, Ambassador, it was a pleasure,} said Alice, watched as he departed the office then turned towards Ferin and looked at him inquiringly, \say{So\dots Port Dauruna, huh? Royal College? Graduated from University with distinction? What should I expect next, Ferin? I definitely have a secretary of Royal Academy of Arts and Sciences in the list of visitors today. If you happen to be an active member of the said Academy, I would rather hear it from you now.}

Ferin was silent and looking down for a few moments, then replied, \say{Alice, I am very sorry I have not told you about this part of my biography. When we met and went about together, I somehow assumed that you liked me for my personality of reckless adventurer. It is not that reckless adventurer is completely out of my real character, so I was not entirely pretending to be who I am not, but still\dots I rather strived to maintain and highlight the traits of that character out of fear that if I ever reveal the complete truth you would lose interest in me. I imagined if I told you what I was highly praised by my mentors in the University for, you will find me boring. Even though this work alone, if I gave it just a bit more effort, would have eventually landed me as an active member of Royal Academy.}

\say{Ferin, you pathetic and wretched fool of a liar, damn you. Have you not met with any girls before me at all? How did that simple fact completely avoided your attention that girls do like muscles, reflexes \textit{and} a sense of humor and decent brainpower much more than just muscles and reflexes alone? What were you thinking of me? I am almost feeling offended.}

Alice rang the bell and called, \say{Protocol, come in.}

\section{Late Evening By Fireplace}

Later that day Alice, still fully dressed, laid on her belly on the huge bed, arms and legs spread wide and eyes closed. Ferin sat on the chair by the fireplace and was mindlessly staring at the fires. Minutes flew by.

\say{So,} said Alice, addressing the enormous pillow nearby, \say{Summarize the today's events pertaining your humble personality and deliver a conclusions. That is an order.}

Ferin cleared throat and began, \say{I understood my presence during General Nhusen's lecture as a prerequisite to enlighten me on the true nature of complexity of international relations of Nation of Ezeek, namely the true causes that led to the Great Winter War and political situation as represented by all of the involved parties' interests. However unfair all of this turned out to be towards my people I now do recognize that it was our practices and stands on the treatment of our neighbors that largely made this tragedy possible. Having said that, I still see no way or reason to exonerate King Roraz for orchestrating the war itself as the course of action the Nation of Ezeek has never resorted to or did not plan to employ.}

\say{Oh, really? So what were \textit{two} large Ezeek expeditionary forces doing with apparent intent on closing on Inilpan capital from north and south? Does it seem like a morning jog to you?}, inquired Alice.

\say{Their intent was not apparent. As far as I understood the troop movements from General Nhusen's lecture, both armies engaged Dark Legions \textit{before} they had an opportunity to cross the border into Inilpan. I am not privy to the plans of the Prince's war council, but whether or not the troop movements within their own territory constitute a valid threat to the neighbors is always open to dispute.}

\say{They took Xubash. Last time I checked, pre-war it was Inilpan territory.}

\say{But only after they encountered the forward units of the Dark Legions who were there first. The vicinity of Xubash is a flat tundra with nowhere to find any defensible position and they did not know the numbers of Dark Legions they will be facing, let alone directions from which they will be advancing. Camping in the open would have been plain suicidal. So yes, it is only logical they did not pursue Dark Legions across the river and took Xubash instead, because it is a defensible position.}

\say{So you insist it was a morning jog then, you incorrigible and hopeless stubborn dolt,} Alice yawned, \say{and a frivolous brawl between good old friends? At the expense of poor residents of Xubash, of course. % You know, I have heard some rumors\dots about Sukhai war shamans, specifically concerning the source of their powers in human sacrifices.

Ferin, you have failed this part of a test as a possible ruler. I conclude you have yet to learn that blatant unconditional denial in the face of overwhelming evidence is the oldest trick in the book, but also a sign of utterly incompetent politics. You see, there is this delicate thing called reputation. Which is as hard to gain as it is easy to lose. The reputation is not built by your deeds or decisions, neither by whether they are morally just or not. Rather, the reputation is built by the predictability of you as a player in politics, that is, whether your \textit{observed actions} match your \textit{stated intentions}. The less they do, the less and less people will take your words seriously and eventually you end up with a reputation of someone who lies just for the sake of lying.}

\say{Why should I care about my reputation amongst the enemy?} asked Ferin grudgingly.

\say{Because, my dear, sooner or later every war ends. And yesterday's enemies become today's partners. Just look at the Dark Domain. We do not deny having been persuaded into this war by the King Roraz, while having future economic benefits in mind. We can not possibly insist that the appearance of our troops beyond the gap of Inilpan is some kind of misunderstood accident. Even though at the time it was a tactical secret, the charade was dropped as soon as it began to make no sense anymore. And the Eternal Kingdom also does not deny any of it. We \textit{took responsibility} but you did not. This is why next time something happens, the important people of the world will listen to me, to Eternal Kingdom, but \textit{not} to you. This is the price of reputation you have yet to learn.

All right, what about Ambassador Tam?}

\say{If everything he said is to be believed}, began Ferin, \say{the Nation of Ezeek is in a state of deep political crisis and he literally took the mere fact of my presence during the audience as a sign that you somehow plan to hand the Sceptre to me, by force if needed. I am sorry, this part I still can not comprehend. I\dots Everything just happened so fast and changed our lives so drastically, I did not get used to it yet. Just yesterday I was a leader of daredevil warband and you were a loyal companion and my romantic interest. Today you are the ruler of the Dark Domain and I am basically no one, not even a citizen of your domain.

I perceive your gratitude and care, but to what extent and did I really deserve it, I do not know.}

\say{Ferin, do you trust me?}

\say{What do you mean, Alice?}

\say{I meant exactly what I said. Do you honestly, truly, unconditionally believe that whatever I do that concerns you is aimed towards helping you achieve your dreams and aspirations? Now that I am finally able to do so in major part thanks to you. I am being grateful. Do you trust me or is it time for me to beat you up again?}

Alice raised her head and looked at Ferin. He returned look. They looked at each other for a few moments and then Ferin said very seriously, \say{I do trust you, Alice. Because, in the end, if not you, who else is there to trust?}

Alice smiled and said, \say{Good. Keep it that way, Ferin, and you would not be disappointed.

Good night.}

And there was night and the night was dark and full of hopes.
